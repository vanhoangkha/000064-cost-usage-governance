...
6. Click vào ô Filter, điền tên policy chúng ta đã tạo ở bước trước ( **EC2_FamilyRestrict** ).
    + Ấn phím **Enter**.

7. Click chọn checkbox kế bên **EC2_FamilyRestrict** policy.
    + Click **Add permissions**.
...
9. Click chọn **RegionRestrict** policy.
    + Click **Remove**.
